export const proyectos = {
  ...
  apvmern: {
    boton: ["React", "Express", "MongoDB", "NodeJS", "TailwindCSS"],
    link: "https://regal-faloodeh-f47ee4.netlify.app/",
    img: "APV",
  ...
  crmidb: {
    ...
    link: "https://proy-crmindexeddb.netlify.app/",
    title: "CRM IndexedDB Administrador clientes",
    img: "CRMIDB",
    texto:
      "Creando una DataBase CRM con indexedDB de clientes, con validación, creación de DB, transacciones, Creación, Lectura, Actualizacion y Eliminado (CRUD) de valores de la DB.",
